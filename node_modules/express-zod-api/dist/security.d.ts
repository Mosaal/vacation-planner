...
declare type AuthCodeFlow<S extends string> = AuthUrl & TokenUrl & RefreshUrl & Scopes<S>;
declare type ImplicitFlow<S extends string> = AuthUrl & RefreshUrl & Scopes<S>;
declare type PasswordFlow<S extends string> = TokenUrl & RefreshUrl & Scopes<S>;
declare type ClientCredFlow<S extends string> = TokenUrl & RefreshUrl & Scopes<S>;
/**
 ...
 * */
export declare type Security<K extends string = string, S extends string = string> = BasicSecurity | BearerSecurity | InputSecurity<K> | CustomHeaderSecurity | CookieSecurity | OpenIdSecurity | OAuth2Security<S>;
export {};
