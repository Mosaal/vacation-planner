...
class Endpoint extends AbstractEndpoint {
    ...
    getSecurity() {
        return this.middlewares.reduce((acc, middleware) => middleware.security ? (0, logical_container_1.combineContainers)(acc, middleware.security) : acc, { and: [] });
    }
    getScopes() {
        return this.scopes;
    }
    ...
    async execute({ request, response, logger, config, }) {
        const method = (0, common_helpers_1.getActualMethod)(request);
        let output;
        let error = null;
        if (config.cors) {
        ...
        try {
            ...
            error = (0, common_helpers_1.makeErrorFromAnything)(e);
        }
...
_Endpoint_instances = new WeakSet(), _Endpoint_getDefaultCorsHeaders = function _Endpoint_getDefaultCorsHeaders() {
    ...
    try {
        ...
        throw (0, common_helpers_1.makeErrorFromAnything)(e);
    }
